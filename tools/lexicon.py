...
PERSONS += [
    ...
    {"id": "person_hu_shiwen", "name": "胡師文", "subtype": "official", "family": "court",
     "aliases": [], "bio": "東平府尹，與西門慶相交，苗青一案照原文書疊成案卷；曾御史批下後，調委陽穀縣丞狄斯彬查辦。"},
    ...
    {"id": "person_huang_mei", "name": "黃美", "subtype": "official", "family": "court",
     "aliases": ["黃通判"],
     "bio": "苗天秀表兄，揚州人，舉人出身，在東京開封府做通判，受安童告狀後行文追究苗青。"},
    ...
    {"id": "person_lei_qiyuan", "name": "雷啟元", "subtype": "official", "family": "court",
     "aliases": [], "bio": "山東兵備副使，與汪伯彥、安忱同來拜望西門慶。"},
    {"id": "person_xu_song", "name": "徐崧", "subtype": "official", "family": "court",
     "aliases": [], "bio": "東昌府知府，第六十五回同赴廳參黃太尉。"},
