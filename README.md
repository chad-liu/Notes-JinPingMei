...
- **人物關係圖**：293 位人物的共現網絡，疊上人工整理的婚配、私通、主僕、結拜、官場依附與仇讎關係，並依家族／陣營分群。
- **共現圖**：人物、身份、建築、地點、意象五類實體的段落共現網絡，可依章回篩選。
- **人物列表**：分兩個分頁。「人物卡片」是 293 位人物一覽，可依身分、陣營篩選，或用人名、別名、簡介關鍵字搜尋，點任一人跳到瀏覽頁看簡介、表記、共現與出處段落；「關係簡圖」是 `data/金瓶梅人物關係簡圖.svg`（1987 年手繪原圖轉繪），可切換符合寬度／原寸或另開原圖。
- **統計**：人物、實體類型、意象、章回篇幅、關係與陣營的視覺化。
- **延伸閱讀**：嵌入《花甲美魔男之斜批金瓶梅》三十篇（整理自蔡詩萍的臉書），附章節目錄、字級調整與夜間模式。
...
- `tools/lexicon.py`：實體詞表。人物、建築、地點、身份、意象共 378 個實體、564 個表記，
  每個表記都先在全文中驗證過出現次數。
- `tools/relations.py`：323 筆人工整理的人物語義關係，涵蓋 255 位人物。
  只收書中明文交代的關係——親屬、主僕、同班、共謀、依附；僅僅同場出現而
  無明文關係的不補，那已由同段共現呈現。
...
別名（瓶兒、月娘、五娘、六姐）與正名指向同一個實體，因此詞頻、共現與檢索
都以人物為單位彙總。

意象一類收的是《金瓶梅》裡帶敘事重量的器物與節候——銀子、當鋪、春藥、汗巾、
鞋兒、琵琶、寶卷、元宵、棺材、算命、報應——也就是「酒色財氣」的物質形式。

人物涵蓋 `data/金瓶梅人物關係.md` 名單裡全文確有出現的人名。收不收要看實際上下文：
與花名、套語撞字的一概不取（海棠、芙蓉、荷花、臘梅是花，「陳三」多是宴席套語
「湯陳三獻」）。`tools/scan_names.py` 負責把名單與全文核對，
`tools/check_candidates.py` 則用與正式比對相同的長詞優先規則，算出候選名
扣掉既有長詞後真正還會命中幾次並列出上下文——只看字串出現次數會高估，
例如「香兒」52 次裡獨立出現的只有 21 次，而那 21 次幾乎都是「丁香兒」「齊香兒」。
