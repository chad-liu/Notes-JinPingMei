...
- **人物關係圖**：292 位人物的共現網絡，疊上人工整理的婚配、私通、主僕、結拜、官場依附與仇讎關係，並依家族／陣營分群。
- **共現圖**：人物、身份、建築、地點、意象五類實體的段落共現網絡，可依章回篩選。
- **人物列表**：292 位人物一覽，可依身分、陣營篩選，或用人名、別名、簡介關鍵字搜尋；點任一人跳到瀏覽頁，直接看他的簡介、表記、共現與出處段落。
...
- `tools/lexicon.py`：實體詞表。人物、建築、地點、身份、意象共 377 個實體、562 個表記，
  每個表記都先在全文中驗證過出現次數。
- `tools/relations.py`：186 筆人工整理的人物語義關係（以主要人物為主；
  次要人物在圖上以同段共現與所屬陣營呈現）。
